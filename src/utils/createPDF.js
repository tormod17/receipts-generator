...
export function createPDF(receipts, selectedArray) {
  ...
  const letter = {
    ...
    customer: {
      ...
      Stadt: receipt['Stadt'],
      PLZ: receipt['Straße'],
      'Kunden-nummer': receipt['Kunden-nummer']
    },
    heading: 'Rechnungsübersicht',
    textNumber: 'Rechnungsnummer    '+ receipt['Rechnungsnummer'],
...
// const {vfs} = vfsFonts.doc;
// doc.vfs = vfs;

//  console.log(vfs, vfsFonts);
//doc.addFileToVFS(sansPro, vfsFonts);
//doc.addFont(sansPro, 'SourceSansPro-Regular', 'normal');

// doc.addImage(logo, 'PNG', 20, 10, 80, 0);
// doc.setFontSize(8);
// doc.setTextColor(20);
// doc.setFontStyle('normal');
// doc.setFont('helvetica');
// doc.setFontSize(8);
// doc.text(20, 60, 'Airgreets Gmbh');
// doc.text(50, 60,'Kaufinger Straße 15' );
// doc.text(80, 60, '80331 München');

// doc.setFontSize(8);  
// doc.text(receipt['Kunde'], 20, 70);
// doc.text(receipt['Stadt'], 20, 76);
// doc.text(receipt['PLZ'] + ' ' +receipt['Straße'], 20, 82);
// doc.text(receipt['Kunden-nummer'], 20, 88);

// doc.text(155, 80, 'Airgreets Gmbh');
// doc.text(146, 86,'Kaufinger Straße 15' );
// doc.text(135, 92, '80331 München');
// doc.text(144, 98, 'hello@Airgreets.com' );
// doc.text(100, 110, 'München, den   31.10.2017');

// doc.setFontType('bold');
// doc.setFontSize(18);
// doc.setTextColor(18, 141, 151);
// doc.text(20, 120, 'Rechnungsübersicht');

// doc.setFontType('bold');
// doc.setFontSize(12);
// doc.setTextColor(20);
// doc.text('Rechnungsnummer      '+ receipt['Rechnungsnummer'], 20, 130);
// doc.setFontType('normal');
// doc.text('Bitte bei Zahlung und Schriftverkehr angeben', 20, 138);
...
// doc.setFontSize(8);
// doc.text('Bitte überweise obigen Betrag bis zum 15.11.17 auf das untenstehende Konto', 20, 220);
// doc.text('Beste Grube', 20, 228);
// doc.text('Florian', 20, 236);

// doc.setFontSize(7);
// doc.text('IBAN: DE49700700240017773300, SWIFT-BIC: DEUTDEDBMUC', 20, 260);
// doc.text('Geschäftsführung: Julian Ritter, Sebastian Drescher',20, 265);
// doc.text('Florian Bogenschütz Handelsregister: Amtsgericht München, HRB-Nr. 227243',20, 270);
// doc.text('Sitz der Gesellschaft: München Steuernr: 143/112/10719',20, 275);
// doc.save('layout.pdf');