...
export function createPDF(clients, selectedArray) {
  ...
  const letter = {
    ...
    customer: {
      ...
      Stadt: client['Stadt'],
      PLZ: client['Straße'],
      'Kunden-nummer': client['Kunden-nummer']
    },
    heading: 'Rechnungsübersicht',
    textNumber: 'Rechnungsnummer    '+ client['Rechnungsnummer'],
